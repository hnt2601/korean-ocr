...
class CharacterOps(object):
    ...
    def __init__(self, config):
        ...
        elif self.character_type in ["ch", "japan", "korean", "french", "german"]:
...
def cal_predicts_accuracy(
    char_ops, preds, preds_lod, labels, labels_lod, is_remove_duplicate=False
):
    """
